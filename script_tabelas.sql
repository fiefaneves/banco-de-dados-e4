...
CREATE TABLE Chocolate (
    ...
    CONSTRAINT FK_CHOC_CRIANCA FOREIGN KEY (CPF_CRIANCA) REFERENCES Criança(CPF)
);
...
CREATE TABLE Visita (
    ...
    CONSTRAINT FK_VISITA_CRIANCA FOREIGN KEY (CPF_CRIANCA) REFERENCES Criança(CPF),
...
CREATE TABLE Acidente (
    ...
    Musica VARCHAR2(100),
    CPF_Criança_Visita VARCHAR2(11) NOT NULL,
